          ...
          <Card className="p-8">
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Você será apresentado a situações realistas de desenvolvimento em IoB
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3 text-foreground">
                <p className="flex items-start gap-2">
                  ...
                  <span>Você lerá cenários que simulam decisões técnicas reais em projetos de Internet dos Corpos</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="font-semibold text-primary">2.</span>
                  <span>Para cada cenário, você escolherá entre opções de design, implementação ou gestão de dados</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="font-semibold text-primary">3.</span>
                  <span>Após cada escolha, você receberá feedback técnico contextualizado sobre implicações éticas</span>
                </p>
                <p className="flex items-start gap-2">
                  <span className="font-semibold text-primary">4.</span>
                  <span>Não existem respostas "certas" ou "erradas" - queremos entender seu raciocínio atual</span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-institutional-light p-6 rounded-lg mb-8">
              ...
              <ul className="space-y-2 text-foreground text-sm">
                ...
                <li>• Suas respostas são anônimas e não serão associadas à sua identidade</li>
                <li>• O feedback educacional será exibido após cada decisão</li>
                <li>• São 5 cenários no total, levando aproximadamente 15-20 minutos</li>
              </ul>
            </div>
